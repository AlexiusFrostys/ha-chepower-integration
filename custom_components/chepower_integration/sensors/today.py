...
class ChePowerTodaySensor(Entity):
    ...
    async def async_update(self):
        ...
        # data = json.loads('{"status": "ok", "aData": [{"time_from": "00:00", "time_to": "00:30", "queue": 2}, {"time_from": "00:30", "time_to": "02:30", "queue": 3}, {"time_from": "02:30", "time_to": "03:00", "queue": 2}, {"time_from": "03:00", "time_to": "10:00", "queue": 1}, {"time_from": "10:00", "time_to": "10:30", "queue": 2}, {"time_from": "10:30", "time_to": "13:00", "queue": 3}, {"time_from": "13:00", "time_to": "13:30", "queue": 2}, {"time_from": "13:30", "time_to": "17:00", "queue": 1}, {"time_from": "17:00", "time_to": "17:30", "queue": 2}, {"time_from": "17:30", "time_to": "20:00", "queue": 3}, {"time_from": "20:00", "time_to": "20:30", "queue": 2}, {"time_from": "20:30", "time_to": "00:00", "queue": 1}], "aState": {"1": {"name": "\u041d\u0435 \u0432\u0456\u0434\u043a\u043b\u044e\u0447\u0430\u0454\u0442\u044c\u0441\u044f", "color": "#63aa18"}, "2": {"name": "\u0420\u043e\u0437\u043c\u0456\u043d \u0447\u0435\u0440\u0433\u0438/\u043f\u0456\u0434\u0447\u0435\u0440\u0433\u0438", "color": "#AFAFAF"}, "3": {"name": "\u0412\u0456\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u043d\u044f", "color": "#E33535"}}}')
